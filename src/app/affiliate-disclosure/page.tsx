...
export const metadata = buildMetadata({
  ...
  description:
    "How Roamora makes money through affiliate partnerships — and why you can trust our recommendations.",
...
export default function AffiliateDisclosurePage() {
  return (
    <LegalPage crumb="Affiliate Disclosure" title="Affiliate Disclosure" updated="August 30, 2026">
      <h2>How Roamora is funded</h2>
      <p>
        Roamora is an independent travel media brand. Our content is researched and written by editors who care
      ...
      <p>
        Affiliate links on Roamora include the attributes <code>rel=&quot;nofollow sponsored&quot;</code> so search
      ...
      <p>
        ...
        at <a href="mailto:partners@roamora.com">partners@roamora.com</a>.
      </p>
    </LegalPage>
  );
}