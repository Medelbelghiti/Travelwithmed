...
async function main() {
  console.log("Seeding tips articlesâ€¦");
  ...
  const flightsBlocks: ContentBlock[] = [
    ...
    { type: "p", text: "The old rule-of-thumb holds up broadly: book international trips two to six months out, shorter-haul flights one to three months out, and avoid the 14-day window where prices climb. Booking earlier than six months rarely helps â€” airlines price high at launch." },
    ...
    { type: "p", text: "Price tracking alerts do the surveillance work you'd otherwise do manually. Enter a route, set a target price, and you'll get notified when a fare dips â€” this is how routine savings of 10-30% happen, because most cheap windows last only hours." },
    { type: "h2", text: "What works and what doesn't" },
    { type: "table", headers: ["Tactic", "Verdict"], rows: [
      ["Booking on 'the cheapest day of the week'", "Myth â€” day-of-week savings are tiny and inconsistent"],
      ["Clearing your browser cookies", "Myth â€” prices have never been tied to cookies"],
      ["Flexible date searches", "Wins â€” weekdays and shoulder dates regularly cost less"],
      ["Nearby airports", "Wins â€” secondary airports often cut fares dramatically"],
      ["Setting price alerts", "Wins â€” automation beats manual checking"],
      ["Travel in shoulder season", "Wins â€” the cheapest month is usually the off-peak one"],
    ] },
    { type: "faq", items: [
      ...
      { question: "Is booking on Tuesday actually cheaper?", answer: "No â€” that's a persistent myth. Date-of-week effects are small; flexible dates within a month matter far more than the day you shop." },
  ...
  const packingBlocks: ContentBlock[] = [
    { type: "p", text: "Most travellers pack twice what they need and stress once for the privilege. This guide builds a carry-on-only system that works for a week or a year â€” the trick is choosing items that coordinate, compress and multi-task." },
    ...
    { type: "p", text: "An eSIM (a digital SIM you install before departure) means instant, cheap data on landing â€” no hunting for a local SIM shop or wincing at roaming bills. Install it before you leave home while you still have Wi-Fi." },
    ...
    { type: "faq", items: [
      { question: "How do I fit a week into a carry-on?", answer: "Plan to do one sink laundry on day 3 or 4 â€” with quick-dry fabrics a small bag covers a week comfortably. Most discrepancies between packed and needed items appear in the first 24 hours." },
      ...
      { question: "Is it worth buying packing cubes?", answer: "For most airline bag allowances, yes â€” they protect clothes from airport handling and compress bulk by 20-40%." },
    ] },
  ];
  await upsertArticle({
  ...
  const insuranceBlocks: ContentBlock[] = [
    { type: "p", text: "Travel insurance is the easiest money to resent and the easiest to be grateful for â€” until you need it. This guide covers what policies actually do, the coverage numbers that matter, and the exclusions that quietly invalidate claims." },
    { type: "h2", text: "The coverage that matters most" },
    { type: "ol", items: ["Emergency medical treatment abroad â€” the reason insurance exists; a hospital stay without it can cost five to six figures", "Emergency medical evacuation and repatriation â€” the single most expensive risk to insure", "Trip cancellation and interruption â€” covers prepaid flights, hotels and tours when plans break", "Lost, delayed or stolen baggage and personal belongings", "24/7 assistance line â€” the human contact you don't value until the crisis"] },
    ...
    { type: "table", headers: ["Coverage", "What to expect"], rows: [
      ...
      ["Personal effects", "Limits per item â€” keep the big-tech receipts"],
    ] },
    { type: "h2", text: "The exclusions that catch people out" },
    { type: "ul", items: ["Pre-existing conditions: usually excluded unless you declare them at signup", "Adventure sports: skiing, scuba and hiking over altitude are often add-on riders", "'Reckless' behaviour as defined by the policy â€” read the small print on motorbikes", "Travel to high-risk regions earns exclusions or cancellation â€” check your destination", "Alcohol-and-injury claims get scrutinised; no policy covers bars' mishaps well"] },
    { type: "h2", text: "Buy before you leave" },
    { type: "p", text: "Insurers are refundable-cooling-off-friendly before departure, but once you've left your home country, almost nothing about the policy can be changed. Buy the policy the same day you book the flights â€” then an injury before the trip is covered by the cancellation part too." },
    ...
    { type: "faq", items: [
      { question: "Do I really need travel insurance for a short trip?", answer: "If the direct cost of an emergency hospital visit or an evacuation exceeds what you can self-insure, yes â€” and for most travellers it does by a wide margin." },
      { question: "How much does travel insurance cost?", answer: "Roughly 4-8% of the trip's prepaid cost, or a flat weekly/monthly subscription for frequent travellers â€” the cheapest four to six weeks of precaution you'll buy." },
      { question: "My card includes insurance. Is that enough?", answer: "Card cover varies wildly â€” check medical limits, evac ceilings and exclusions for your exact product before relying on it, especially for long-haul or adventure trips." },
    ] },
  ];
  await upsertArticle({
    title: "How to Choose Travel Insurance (And Read the Fine Print)",
    slug: "how-to-choose-travel-insurance",
    excerpt: "The coverage numbers that matter, the exclusions that void claims and when to buy â€” a no-nonsense guide to travel insurance.",
    type: "TRAVEL_TIPS",
    destinationId: null,
  ...
  const scamsBlocks: ContentBlock[] = [
    ...
    { type: "p", text: "A stranger presses a bracelet, flower or keyring into your hand 'for free', then demands payment once you're holding it. Defence: don't take anything handed to you â€” keep hands in pockets and keep moving." },
    { type: "h3", text: "3. The fake police check" },
    { type: "p", text: "Someone shows a badge on the street, claims a counterfeiting check and asks to see your wallet and cards â€” a distraction for pickpocketing or card skimming. Defence: real police don't do random street wallet checks; walk away into shops or crowds." },
    ...
    { type: "p", text: "ATMs and card terminals offer to charge you in your home currency at a terrible rate. Defence: always choose the local currency at the terminal â€” the conversion happens at your bank's far better rate." },
    ...
    { type: "p", text: "Phishing emails or WhatsApp 'assistants' ask you to 'verify' payment details for a flight or hotel. Defence: only trust payment links inside the authentic app or site you booked on â€” call the number you originally used." },
    { type: "h2", text: "Market and street scenes across Asia" },
    { type: "h3", text: "12. The 'free sample' hard sell" },
    { type: "p", text: "A saffron, tea or spice stall hands you a 'complimentary' spoonful, then demands an outrageous price once you've eaten it. Defence: smile, decline, and step away â€” don't touch anything you won't buy." },
    ...
    { type: "affiliate_link", linkId: linkId("SafetyWing", "INSURANCE") ?? "cmthy4nu4001fdsvj6hjol4ac", label: "Travel covered â€” get insurance before you leave" },
    { type: "faq", items: [
      { question: "Are pickpockets really that common in Europe?", answer: "Not in general life, yes in the hot spots â€” metro doors, major squares and attraction queues in cities like Barcelona, Rome and Paris. Awareness at those choke points prevents 95% of incidents." },
      { question: "What should I do if I'm scammed?", answer: "Move to a safe, public place, cancel cards via your banking app immediately, and report to local police â€” the report helps your insurance claim for any loss." },
      { question: "How do I tell a real police officer from a fake one?", answer: "Real officers rarely solicit checks on the street. If approached, keep your documents inside your hand and agree to be escorted to a station â€” genuine police accept this instantly." },
    ] },
  ];
  await upsertArticle({
    title: "14 Travel Scams to Avoid in 2026 (And How to Spot Each One)",
    slug: "travel-scams-to-avoid",
    excerpt: "The fourteen most common travel scams across Europe, Morocco and Asia â€” what they look like and the one-line defence for each.",
    type: "LISTICLE",
    destinationId: null,
  ...
  const planningBlocks: ContentBlock[] = [
    { type: "p", text: "Planned trips beat spontaneous dreams, and the planning itself has a reliable order. This checklist turns 'I want to travel somewhere' into a booked, insured, packed reality â€” in the sequence that avoids the classic expensive mistakes." },
    { type: "h2", text: "The sixteen-step planning order" },
    { type: "ol", items: ["Lock the dates and the trip duration â€” everything else follows", "Set the overall budget and a per-day rate you won't silently blow", "Shortlist 3-4 destinations and rank them by visa, season and cost", "Check passport validity (6 months is the common rule) and visa needs now", "Confirm the seasonal weather and any big events or closures", "Book the flights that lock your dates â€” everything else is elastic around them", "Buy travel insurance the same week as the flights, not the night before", "Book accommodation with free cancellation so plans can flex", "Sketch a loose day-by-day skeleton, one dose of realism at a time", "Reserve the must-have timed tickets â€” museums, shuttles, iconic sites", "Sort money: two cards in separate places, some local cash, banking alerts on", "Arrange connectivity: an eSIM installed at home beats a roaming surprise", "Pack from a carry-on list, not the contents of a wardrobe", "Confirm ground transport from the airport or station before landing", "Digitise documents â€” passport, visa, insurance, itinerary â€” into the cloud", "Share your plan with someone at home and note the local emergency number"] },
    ...
    { type: "faq", items: [
      ...
      { question: "What's the biggest trip-planning mistake?", answer: "Booking the return before checking whether an onward visa exists, and over-scheduling â€” leave at least one unbooked afternoon per three days." },
    ] },
  ];
  await upsertArticle({
    title: "How to Plan a Trip: The Complete 16-Step Checklist",
    slug: "how-to-plan-a-trip",
    excerpt: "A repeatable trip-planning sequence from dates and budget to documents and airport transfers â€” the order that avoids the expensive mistakes.",
    type: "RESOURCE_GUIDE",
    destinationId: null,
  ...
  const baliTimeBlocks: ContentBlock[] = [
    ...
    { type: "p", text: "Nyepi, the Balinese New Year, is a day of complete silence â€” no flights, no traffic, no activities, with airport closures. It's fascinating culture and a genuine logistics event: plan around the exact date if you land or leave in late February to March." },
    { type: "h2", text: "Crowds, festivals and what to book" },
    { type: "ul", items: ["August is the heaviest rush â€” book flights and hotels months ahead", "Christmas and New Year spike prices across the board", "Rainy-season Bali is greener, emptier and cheaper â€” ideal for culture, temples and spas", "Ubud's temple festivals and Galungan days are a reason to visit in either season"] },
    ...
    { type: "faq", items: [
      { question: "What's the cheapest time to visit Bali?", answer: "The wet-season months of January to March and November generally carry the lowest hotel prices and lightest crowds â€” the main cost is a greater chance of afternoon rain." },
      { question: "Is the wet season a bad time to go?", answer: "No â€” it's still warm (around 27-30Â°C), and rain usually falls in short daily bursts. The island turns a deeper green and temple sights stay fully open." },
      { question: "Are flights cheaper to Bali in the wet season?", answer: "Often, yes â€” shoulder demand around November and February-March regularly produces under-$500 return fares from major European hubs." },
    ] },
  ];
  await upsertArticle({
    title: "Best Time to Visit Bali: A Month-by-Month Guide",
    slug: "best-time-to-visit-bali",
    excerpt: "Dry versus wet season, the Nyepi silent day and the months that balance weather, crowds and price â€” a month-by-month Bali guide.",
    type: "THINGS_TO_DO",
  ...
  const soloBlocks: ContentBlock[] = [
    { type: "p", text: "Solo travel rewards preparation: the prep is what converts worry into confidence. These are the habits experienced solo travellers repeat â€” around safety, money, navigation and meeting people â€” that read as universal rather than gendered." },
    { type: "h2", text: "Before you go" },
    { type: "ul", items: ["Book your first two nights at a well-reviewed central property â€” removing the arrival panic solves the riskiest stretch", "Share your live location with one trusted person for the whole trip, not just day one", "Photograph your documents into cloud storage and keep a paper backup separate", "Download offline maps for the whole city â€” navigation without data is a superpower", "Note the local emergency number and your embassy's contact in your phone"] },
    { type: "h2", text: "Arrival habits" },
    { type: "ul", items: ["Land in daylight whenever the schedule allows â€” most avoidable stress happens on the first airport dash", "Arrange the first transfer in advance; the tired-you crowd is a different negotiator", "Don't advertise solo status in check-in queues or bar conversations â€” every room number is a potential detail", "Keep the phone charged with a backup power bank; a dead phone is a small emergency"] },
    { type: "h2", text: "Everyday patterns" },
    { type: "ul", items: ["The 'night rule': first nights belong to group activities â€” cooking classes, food tours, day trips â€” not late bars", "Meet people through daytime activities where one beds in a whole group of companions", "Choose the side of the street with light and people, and trust the instinct that says the detour is worth it", "Split cash and cards so a single loss isn't a trip-ender"] },
    ...
    { type: "faq", items: [
      ...
      { question: "How do I meet people while travelling alone?", answer: "Daytime group activities â€” food tours, cooking classes, day trips â€” attract exactly the travellers trying to meet people. They beat bar-scene spontaneity for most solos." },
  ...
  await upsertArticle({
    ...
    excerpt: "The arrival habits, night rules and everyday patterns seasoned solo travellers use â€” practical safety that doesn't replace curiosity.",
    type: "TRAVEL_TIPS",
    destinationId: null,
