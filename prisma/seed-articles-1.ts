...
async function main() {
  console.log("Seeding destination articlesâ€¦");
  ...
  const romeBlocks: ContentBlock[] = [
    { type: "p", text: "Rome is three thousand years of history stacked on a walkable scale, but it rewards planning before you go. The two decisions that shape most first trips are where to stay and how you book the Colosseum â€” both are easier than people think once you know how the system works." },
    { type: "h2", text: "Rome in brief" },
    { type: "ul", items: ["Airport arrival: Fiumicino (FCO) via the non-stop Leonardo Express (about 32 minutes to Termini, around â‚¬14) or the slower FL1 regional train", "Currency: Euro; cards are accepted almost everywhere, carry a little cash for markets", "Walking is the real transport system â€” most highlights sit inside a 45-minute stroll", "Public transit: single metro/bus ticket â‚¬1.50, valid 100 minutes, including one metro ride"] },
    { type: "h2", text: "Where to stay" },
    { type: "p", text: "For a first visit, staying inside the old centre â€” near Piazza Navona, Campo de' Fiori or Trevi â€” means you can walk most of the itinerary. Trastevere, just across the Tiber, costs a little less and hands you the city's best restaurant street as a doorstep." },
    { type: "ul", items: ["Centro Storico â€” maximum charm, maximum walking", "Trastevere â€” evening energy, great food, slightly outside the crowds", "Near Termini â€” cheaper and convenient for early trains, quieter at night", "Monti â€” a tiny, stylish neighbourhood short walk from the Colosseum"] },
    ...
    { type: "p", text: "The metro has three lines and only touches some of the highlights, so expect to combine short rides with walking. Tickets work on bus, tram and metro; buy them at metro stations, tobacconists or the official app before boarding â€” inspectors don't accept excuses." },
    { type: "ul", items: ["Metro/bus single: â‚¬1.50 for 100 minutes", "24-hour pass: about â‚¬7; 48-hour pass: about â‚¬12.50", "Hop a taxi only for luggage hauls â€” otherwise traffic beats walking", "Fiumicinoâ†”city trains beat taxis by a wide margin in both price and time"] },
    ...
    { type: "ul", items: ["Free: Trevi Fountain, the Pantheon exterior, St Peter's Basilica, most piazzas", "Pantheon interior: now requires a â‚¬5 ticket â€” reserve a timed slot online", "St Peter's dome climb: about â‚¬8-10, worth it for the view over the city", "Vatican Museums & Sistine Chapel: book timed entry well ahead"] },
    { type: "faq", items: [
      ...
      { question: "Should I book the Colosseum in advance?", answer: "Yes â€” same-day walk-up tickets sell out, especially in high season. Reserve 30 days ahead on the official portal for the standard ticket, or book a skip-the-line tour for the arena and underground." },
  ...
  const bcnBlocks: ContentBlock[] = [
    { type: "p", text: "Barcelona packs a beach, world-class architecture and a serious food scene into one compact city. The planning that matters most happens before arrival: booking the two GaudÃ­ showpieces and choosing a neighbourhood that matches your rhythm â€” this is a city that starts late and ends late." },
    { type: "h2", text: "The two bookings to make early" },
    { type: "p", text: "Sagrada FamÃ­lia and Park GÃ¼ell both sell timed entry and both sell out in high season. Sagrada FamÃ­lia releases tickets in batches and morning slots go first â€” book directly on the official site rather than paying third-party markups. For Park GÃ¼ell, the Monumental Zone (the part with the famous mosaicked terrace) needs its own reserved entrance." },
    { type: "ul", items: ["Sagrada FamÃ­lia basic entry: around â‚¬26, plus â‚¬4-6 for the tower visit and lift", "Park GÃ¼ell monument zone: around â‚¬10, separate timed tickets", "Book the earliest Sagrada slot for soft light and smaller crowds", "Set reminders â€” both sites open reservations several weeks ahead"] },
    ...
    { type: "ul", items: ["El Born / Gothic Quarter â€” the historic core, boutique stays, great tapas streets", "Eixample â€” grand boulevards and GaudÃ­'s buildings, quieter and wider pavements", "GrÃ cia â€” village-in-the-city feel, local cafÃ©s, less tourist traffic", "Barceloneta â€” beachfront, louder but steps from the sand"] },
    { type: "hotels", title: "Hotels we feature in Barcelona", destinationId: cityIds.barcelona },
    { type: "h2", text: "Getting around" },
    { type: "p", text: "The metro is fast, cheap and covers the sights. A single ride costs around â‚¬2.40; the T-casual 10-ride card is the practical choice for a few days. Walking beats transit in the old town â€” the distance between the Gothic Quarter, the Rambla and the waterfront is an easy stroll." },
    { type: "ul", items: ["Metro: fast and the best option for crossing town", "Walking: the old city is compact and rewarding", "Bike: flat coastal routes and Ciutadella park make it pleasant", "Airport: the R2 Snord train is cheapest; the AerobÃºs is direct to PlaÃ§a de Catalunya"] },
    { type: "h2", text: "Eating like a local" },
    { type: "p", text: "Dinner doesn't start until 9pm and lunch is the big meal. Skip the pre-made paella on the tourist strips near the port and look for counter-service bars serving tapas and pintxos at standing prices â€” some of Barcelona's best meals are one-bite collaborations with a house vermouth." },
    { type: "ul", items: ["Head to GrÃ cia or the streets off La Rambla for honest local prices", "La Boqueria market is gorgeous but touristy â€” shop for fruit, avoid the back-wall overpriced stalls", "Ask for 'conta corrupciÃ³n' etiquette: pay-as-you-go by plate at old-school tapas bars", "Check the 'menu del dÃ­a' at lunch for a fixed-price three-course meal"] },
    ...
    { type: "faq", items: [
      { question: "How many days do I need in Barcelona?", answer: "Three to four days covers the two GaudÃ­ sites, the old town and a beach afternoon with room for a day trip like Montserrat." },
      ...
      { question: "Do I need to book Sagrada FamÃ­lia in advance?", answer: "Almost always yes. Walk-up slots exist on quiet days but vanish in high season; booking online removes the risk and the queue." },
    ] },
  ];
  await upsertArticle({
    title: "Barcelona Travel Guide: Plan a Great First Trip",
    slug: "barcelona-travel-guide",
    excerpt: "How to book Sagrada FamÃ­lia and Park GÃ¼ell, pick a neighbourhood, ride the metro and eat well â€” the practical core of a Barcelona trip.",
    type: "DESTINATION_GUIDE",
  ...
  const baliBlocks: ContentBlock[] = [
    { type: "p", text: "Bali is small enough to change regions in an afternoon and varied enough to feel like several islands. The big-ticket planning questions are entry requirements, which area matches your trip, and how you'll move around â€” skip those and a lovely trip turns stressful fast." },
    { type: "h2", text: "Arrival and entry basics" },
    { type: "ul", items: ["Visas: most nationalities can use the Visa on Arrival / eVOA (30 days, roughly IDR 500,000) â€” arrange it online before flying", "Currency: Indonesian rupiah (IDR); carry cash for warungs, hotels and drivers are happy with cards", "Airport: Ngurah Rai (DPS) near Kuta; arrange a driver or use a ride app for sane airport fares", "Language: Indonesian and Balinese; English works well in tourist areas"] },
    ...
    { type: "h2", text: "Getting around" },
    { type: "p", text: "Most visitors pick between a scooter and a car with driver. Scooters are cheap and free, but southern traffic and unfamiliar roads make them a real hazard for first-timers â€” an international licence is required and local enforcement is relaxed until it isn't. A car and driver for the day, shared between a few people, is often the saner and barely more expensive option." },
    ...
    { type: "p", text: "Bali's temples are living, working places. Cover shoulders and knees, wear a sash if offered, and step around rather than over offerings in the street. Remember the island's min 'quiet days' â€” Nyepi, the Balinese New Year â€” when everything closes for 24 hours, so flights and activities shut down too." },
  ...
  await upsertArticle({
    ...
    excerpt: "Visas, the right region for your trip, scooter-versus-driver transport and temple etiquette â€” everything to sort before a first Bali trip.",
    type: "DESTINATION_GUIDE",
  ...
  const osakaBlocks: ContentBlock[] = [
    { type: "p", text: "Osaka is Japan's street-food capital and the country's most relaxed big city. It's also the smartest base in the region â€” Kyoto, Nara and Kobe all sit within a 30-45 minute train ride, so many travellers end up using Osaka's cheaper hotels as a home base for a week of day trips." },
    { type: "h2", text: "What makes Osaka different from Tokyo" },
    { type: "ul", items: ["Dotonbori: an artery of neon signs, takoyaki stalls and riverside crowds â€” best seen at night", "The Kansai food culture: takoyaki, okonomiyaki and kushikatsu, made to order in front of you", "A genuinely friendly localism â€” Osaka's banter culture is famous across Japan", "Fewer temples than Kyoto, more eating, drinking and people-watching"] },
    { type: "h2", text: "Two districts, one Osaka" },
    { type: "p", text: "The city splits into Minami (the Namba, Dotonbori and Shinsaibashi area â€” where the action is) and Kita (Umeda, the business and shopping heart). Most first trips orbit Minami, but a night in Umeda's rooftop garden or below-floor food arcades shows a calmer side." },
    { type: "hotels", title: "Hotels we feature in Osaka", destinationId: cityIds.osaka },
    { type: "h2", text: "Food: the Osaka shortlist" },
    { type: "ul", items: ["Takoyaki: octopus-filled batter balls, get them hot from a street stall in Dotonbori", "Okonomiyaki: the savoury pancake Osaka claims as its own", "Kushikatsu: deep-fried skewers â€” dip in sauce once, it's communal", "Kuromon Ichiba Market: the market corridor best visited in the morning"] },
    ...
    { type: "faq", items: [
      { question: "Is Osaka a good base for visiting Kyoto?", answer: "Yes â€” the direct rail link takes about 30 minutes, and Osaka hotels are often cheaper than Kyoto's. Base yourself in one city and day-trip the other." },
  ...
  const kyotoBlocks: ContentBlock[] = [
    { type: "p", text: "Kyoto's temples are at their magic hour before the tour groups arrive â€” and that's the entire strategy of a well-planned visit. The single biggest mistake first-timers make is trying to see five famous sites by midday, then hitting traffic jams of people at each one." },
    ...
    { type: "ul", items: ["Fushimi Inari Taisha: open 24 hours â€” the torii gates work best at sunrise", "Kiyomizu-dera: opens at 6am in season, before the hill fills", "Arashiyama bamboo grove: walk it before 8am or after sunset to keep the magic", "Sacred pacing: one megasite in the morning, one neighbourhood in the afternoon"] },
    { type: "h2", text: "Transport: buses beat trains here" },
    { type: "p", text: "Unlike Tokyo, Kyoto's metro is light and the sites spread out, so the 200-yen flat bus fare is the workhorse. Buy a one-day bus card or just tap with an ICOCA. Uphill sites like Kiyomizu and the bamboo grove love a taxi for the first stretch â€” cheap across a group and saves real energy." },
    ...
    { type: "p", text: "A single night in a traditional ryokan is worth the premium â€” futons, yukata robes and a shared bath (usually onsen-style) deliver an evening no hotel can. Book early; the handful of city-centre ryokan sell out months ahead, and the etiquette (shoes off, baths before dinner) is easier than it looks." },
    { type: "h2", text: "Gion etiquette" },
    { type: "ul", items: ["Never chase, grab or block geisha in the streets â€” photographing performers without permission is poor form and often illegal to publish", "Respect wooden machiya buildings: many are private homes", "The flag-lined alleys are for residents first; walk softly after dark", "Book a teahouse experience ahead rather than hoping to stumble into one"] },
  ...
  await upsertArticle({
    ...
    excerpt: "Beat the crowds with the 6am rule, ride the bus network, understand Gion etiquette and plan a ryokan night â€” the essentials of a Kyoto trip.",
    type: "DESTINATION_GUIDE",
  ...
  const kixItineraryBlocks: ContentBlock[] = [
    { type: "p", text: "A relaxed five-day plan that uses Osaka as a cheap base and Kyoto as the cultural heart. The itinerary spreads famous sights across mornings â€” because in Kyoto, the early-riser wins â€” and leaves afternoons for food, gardens and wandering." },
    ...
    { type: "ul", items: ["Day 1 â€” Arrive in Osaka: Dotonbori at night, takoyaki and neon", "Day 2 â€” Kyoto morning: Fushimi Inari at sunrise, then Kiyomizu-dera", "Day 3 â€” Arashiyama before 8am, bamboo grove, then a tea ceremony", "Day 4 â€” Nara day trip, then back to Osaka for Kuromon and street food", "Day 5 â€” Osaka Castle park and the Umeda food arcades before departure"] },
    { type: "h2", text: "Practical notes" },
    { type: "p", text: "An ICOCA card covers every train and bus in the plan, and a compact hotel in Namba or Umeda keeps things simple. Golden Week (late April to early May) is the one stretch to avoid â€” trains and temples hit peak crowd levels." },
    ...
    { type: "affiliate_link", linkId: linkId("GetYourGuide", "ACTIVITIES") ?? "cmthy4mmf001ddsvjqgh8lluh", label: "Browse Kyoto experiences" },
    { type: "faq", items: [
      { question: "Should I stay in Osaka or Kyoto?", answer: "Osaka is usually cheaper and livelier at night; Kyoto holds more atmosphere. Either works as a base â€” the two cities are 30 minutes apart, so pick by hotel price and nightlife taste." },
  ...
  const kixArticle = await upsertArticle({
    ...
    excerpt: "Sunrise shrines, bamboo groves, street food and a Nara day trip â€” a five-day plan that balances Kyoto culture with Osaka's night energy.",
    type: "ITINERARY",
    destinationId: cityIds.kyoto,
  ...
  if (kixRow) {
    const days: { dayNumber: number; description: string; activities: string[]; restaurants: string[]; hotel: string; transportation: string; estimatedCost: number }[] = [
      ...
      { dayNumber: 5, description: "Last morning in Osaka Castle park and the Umeda underground food arcades, then to the airport.", activities: ["Osaka Castle park", "Umeda chika centres"], restaurants: ["Breakfast in the Umeda arcades"], hotel: "â€”", transportation: "Airport express", estimatedCost: 80 },
    ];
    for (const d of days) {
